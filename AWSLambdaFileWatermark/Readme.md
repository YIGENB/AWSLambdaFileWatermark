...
Once you have edited your function you can use the following command lines to build, test and deploy your function to AWS Lambda from the command line (these examples assume the project name is *AWSLambdaFileWatermark*):

Restore dependencies
```
    cd "AWSLambdaFileWatermark"
    dotnet restore
```

Execute unit tests
```
    cd "AWSLambdaFileWatermark/test/AWSLambdaFileWatermark.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "AWSLambdaFileWatermark/src/AWSLambdaFileWatermark"
